...
EventScript_0x81706C8:
    npcmsg gText_Route25_BillSpeak1 MSG_KEEPOPEN gText_Name_Bill
    closemsg
    release
    end

EventScript_0x8170640:
    npcmsg gText_Route25_BillSpeak2 MSG_KEEPOPEN gText_Name_Bill
    closemsg
    release
    end
...
EventScript_0x8170580:
    npcmsg gText_Route25_BillSpeak2 MSG_KEEPOPEN gText_Name_Unknown
    closemsg
    npcmsg gText_Route25_BillSpeak3 MSG_KEEPOPEN gText_Name_Unknown
    closemsg
    call EventScript_Route25_RocketGang
    npcmsg gText_Route25_BillSpeak7 MSG_YESNO gText_Name_Bill
    closemsg
...
EventScript_0x817058E:
    npcmsg gText_Route25_BillSpeak2 MSG_KEEPOPEN gText_Name_Unknown
    closemsg
    npcmsg gText_Route25_BillSpeak4 MSG_KEEPOPEN gText_Name_Unknown
    closemsg
    call EventScript_Route25_RocketGang
    npcmsg gText_Route25_BillSpeak7 MSG_YESNO gText_Name_Bill
    closemsg
...
EventScript_0x81706AC:
    npcmsg gText_Route25_BillSpeak5 MSG_KEEPOPEN gText_Name_Bill
    closemsg
    return

EventScript_0x81706B5:
    npcmsg gText_Route25_BillSpeak6 MSG_KEEPOPEN gText_Name_Bill
    closemsg
    return

EventScript_0x81706BE:
    npcmsg 0x81A02B4 MSG_KEEPOPEN gText_Name_Bill
    closemsg
    release
    end
...
EventScript_0x817059C:
    ...
    npcmsg 0x819FFD3 MSG_KEEPOPEN gText_Name_Bill
    closemsg
    pause 0xA
...
EventScript_0x8170618:
    npcmsg 0x81A0035 MSG_KEEPOPEN gText_Name_Bill
    closemsg
    return

EventScript_0x8170621:
    npcmsg 0x81A00B6 MSG_KEEPOPEN gText_Name_Bill
    closemsg
    return
...
EventScript_Route25_RocketGang:
    ...
    waitmovement MEOWTH
    playsong 0x184 0x1
    npcmsg gText_Route25_RocketGang_Jessie_Speak_1 MSG_KEEPOPEN gText_Name_Jessie
    closemsg
    npcmsg gText_Route25_RocketGang_James_Speak_1 MSG_KEEPOPEN gText_Name_James
    closemsg
    spriteface JESSIE LEFT
    npcmsg gText_Route25_RocketGang_Jessie_Speak_2 MSG_KEEPOPEN gText_Name_Jessie
    closemsg
    spriteface JAMES RIGHT
    npcmsg gText_Route25_RocketGang_James_Speak_2 MSG_KEEPOPEN gText_Name_James
    closemsg
    spriteface JESSIE DOWN
    npcmsg gText_Route25_RocketGang_Jessie_Speak_3 MSG_KEEPOPEN gText_Name_Jessie
    closemsg
    spriteface JAMES DOWN
    npcmsg gText_Route25_RocketGang_James_Speak_3 MSG_KEEPOPEN gText_Name_James
    closemsg
    sound 0x79
    spriteface JESSIE UP
    npcmsg gText_Route25_RocketGang_Jessie_Speak_4 MSG_KEEPOPEN gText_Name_Jessie
    closemsg
    sound 0x79
    spriteface JAMES UP
    npcmsg gText_Route25_RocketGang_James_Speak_4 MSG_KEEPOPEN gText_Name_James
    closemsg
    npcmsg gText_Route25_RocketGang_Jessie_Speak_5 MSG_KEEPOPEN gText_Name_Jessie
    closemsg
    npcmsg gText_Route25_RocketGang_James_Speak_5 MSG_KEEPOPEN gText_Name_James
    closemsg
    applymovement MEOWTH Move_Route25_RocketGang_Meowth_5
    waitmovement MEOWTH
    npcmsg gText_Route25_RocketGang_Meowth_Speak_1 MSG_KEEPOPEN gText_Name_Meowth
    closemsg
    sound 0x15
    ...
    waitmovement JAMES
    pause 30
    npcmsg gText_Route25_RocketGang_Jessie_Speak_6 MSG_KEEPOPEN gText_Name_Jessie
    closemsg
    pause 30
    spriteface JESSIE RIGHT
    spriteface MEOWTH RIGHT
    spriteface JAMES LEFT
    npcmsg gText_Route25_RocketGang_James_Speak_6 MSG_KEEPOPEN gText_Name_James
    closemsg
    npcmsg gText_Route25_RocketGang_Meowth_Speak_2 MSG_KEEPOPEN gText_Name_Meowth
    closemsg
    npcmsg gText_Route25_RocketGang_Bill_Speak_1 MSG_KEEPOPEN gText_Name_Bill
    closemsg
    pause 30
    ...
    spriteface JAMES UP
    npcmsg gText_Route25_RocketGang_Bill_Speak_2 MSG_KEEPOPEN gText_Name_Bill
    closemsg
    pause 30
    ...
    applymovement BILL_CLEF Move_Route25_RocketGang_Bill_1
    waitmovement BILL_CLEF
    npcmsg gText_Route25_RocketGang_Bill_Speak_3 MSG_KEEPOPEN gText_Name_Bill
    closemsg
    spriteface BILL_CLEF, LEFT
    spriteface PLAYER, RIGHT
    npcmsg gText_Route25_RocketGang_Bill_Speak_4 MSG_KEEPOPEN gText_Name_Bill
    closemsg
    spriteface BILL_CLEF, DOWN
    spriteface PLAYER, DOWN
    npcmsg gText_Route25_RocketGang_Jessie_Speak_7 MSG_KEEPOPEN gText_Name_Jessie
    closemsg
    npcmsg gText_Route25_RocketGang_Meowth_Speak_3 MSG_KEEPOPEN gText_Name_Meowth
    closemsg
    pause 30
    applymovement MEOWTH Move_Route25_RocketGang_Meowth_2
    waitmovement MEOWTH
    npcmsg gText_Route25_RocketGang_Bill_Speak_5 MSG_KEEPOPEN gText_Name_Bill
    closemsg
    ...
    waitmovement CAMERA
    special 0x114
    npcmsg gText_Route25_RocketGang_James_Speak_7 MSG_KEEPOPEN gText_Name_James
    closemsg
    trainerbattle3 0x3 10 0x0 gText_Route25_RocketGang_Defeat
    npcmsg gText_Route25_RocketGang_Jessie_Speak_8 MSG_KEEPOPEN gText_Name_Jessie
    closemsg
    ...
    waitmovement PLAYER
    npcmsg gText_Route25_RocketGang_Bill_Speak_6 MSG_KEEPOPEN gText_Name_Bill
    closemsg
    return
...
EventScript_Route25_Brawly:
    ...
    waitmovement 14
    npcmsg gText_Route25_Brawly_Speak_1 MSG_KEEPOPEN gText_Name_Unknown
    closemsg
    npcmsg gText_Route25_Brawly_Speak_2 MSG_YESNO gText_Name_Brawly
    compare LASTRESULT 0x1
    if notequal _goto EventScript_Route25_Brawly_PlayerDontWantToBattle
    closemsg
    trainerbattle3 0x3 28 0x0 gText_Route25_Brawly_Defeat
    npcmsg gText_Route25_Brawly_Speak_3 MSG_KEEPOPEN gText_Name_Brawly
    closemsg
    giveitem ITEM_BLACK_BELT 0x1 MSG_OBTAIN
    npcmsg gText_Route25_Brawly_Speak_4 MSG_KEEPOPEN gText_Name_Brawly
    closemsg
    fadescreen 0x1
    hidesprite 14
...
EventScript_Route25_Brawly_PlayerDontWantToBattle:
    npcmsg gText_Route25_Brawly_PlayerDontWantToBattle MSG_KEEPOPEN gText_Name_Brawly
    closemsg
    release
    end
