...
#ifdef ESP
extern const u8 gText_Hp1[];
extern const u8 gText_Atq1[];
extern const u8 gText_Def1[];
extern const u8 gText_SpAtk1[];
extern const u8 gText_SpDef1[];
extern const u8 gText_Speed11[];
...
#else
// ENG
const u8 gText_Hp1[]     = _("HP");
const u8 gText_Atq1[]    = _("ATTACK");
const u8 gText_Def1[]    = _("DEFENSE");
const u8 gText_SpAtk1[]  = _("SP.ATK.");
const u8 gText_SpDef1[]  = _("SP.DEF.");
const u8 gText_Speed11[]  = _("SPEED");
...
static void EvIvPrintText(struct Pokemon *mon)
{
    ...
    //STAT_HP
    gStats_bs[STAT_HP] = gBaseStats[species].baseHP;
...
static void PrintWindow1(u8 nature, u8 isEgg)
{
    /*AddTextPrinterParameterized3(WIN_STATS, 2, PS_X, HP_Y,    gTextColorByNature[GetColorByNature(nature, STAT_HP)],    0, gText_Hp1);
    AddTextPrinterParameterized3(WIN_STATS, 2, PS_X, ATK_Y,   gTextColorByNature[GetColorByNature(nature, STAT_ATK)],   0, gText_Atq1);
    AddTextPrinterParameterized3(WIN_STATS, 2, PS_X, DEF_Y,   gTextColorByNature[GetColorByNature(nature, STAT_DEF)],   0, gText_Def1);
    AddTextPrinterParameterized3(WIN_STATS, 2, PS_X, SPATK_Y, gTextColorByNature[GetColorByNature(nature, STAT_SPATK)], 0, gText_SpAtk1);
    AddTextPrinterParameterized3(WIN_STATS, 2, PS_X, SPDEF_Y, gTextColorByNature[GetColorByNature(nature, STAT_SPDEF)], 0, gText_SpDef1);
    AddTextPrinterParameterized3(WIN_STATS, 2, PS_X, SPEED_Y, gTextColorByNature[GetColorByNature(nature, STAT_SPEED)], 0, gText_Speed11);*/
...
static void PrintWindow2(u16 species, u8 isEgg, u8 friendship, u8 ability)
{
    ...
    if(!isEgg)
    {
        ...
        // stuff can get off screen
        //StringCopy(gStringVar4, gText_Your);
        //GetSpeciesName(gStringVar1, species);
        //StringAppend(gStringVar4, gStringVar1);
        StringCopy(gStringVar4, gText_Is);
        temp = friendship;
