...
#define NUM_MOVE_TUTORS 170 //keep this defined even if EXPANDED_MOVE_TUTORS is not!! If using DPE, set to 128.
#define LAST_TOTAL_TUTOR_NUM 178 //Should be equal to (NUM_MOVE_TUTORS - 1) + 9. Must be set to an actual integer or the compilation will not work.
...
#define SQUEETZ // Squeetz Music Patch
#define IV_RANKING_SUMMARY_SCREEN // IV Ranking in Summary Screen
#define SIDEWAY_STAIRS
