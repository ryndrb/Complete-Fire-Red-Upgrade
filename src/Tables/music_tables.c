...
const u16 gClassBasedBattleBGM[NUM_TRAINER_CLASSES] =
{
	...
	[CLASS_LEADER_RS] = BGM_BATTLE_RSE_GYM_LEADER,

	#ifdef SQUEETZ
	[CLASS_BOSS] = BGM_RSE_BATTLE_EVIL_LEADER,
	[CLASS_TEAM_ROCKET] = BGM_RSE_BATTLE_GRUNT,
	[CLASS_PKMN_TRAINER_1] = BGM_RSE_BATTLE_RIVAL,
	#endif
};
...
const u16 gWildSpeciesBasedBattleBGM[] =
{
	...
	[SPECIES_LATIOS] = BGM_RSE_BATTLE_LEGEND,
	[SPECIES_LATIAS] = BGM_RSE_BATTLE_LEGEND,
	[SPECIES_GROUDON] = BGM_RSE_BATTLE_LEGEND,
	[SPECIES_KYOGRE] = BGM_RSE_BATTLE_LEGEND,
	[SPECIES_RAYQUAZA] = BGM_RSE_BATTLE_LEGEND,
	[SPECIES_JIRACHI] = BGM_RSE_BATTLE_LEGEND,
	[SPECIES_DEOXYS] = BGM_BATTLE_DEOXYS,

	[SPECIES_REGIROCK] = BGM_RSE_BATTLE_REGI,
	[SPECIES_REGICE] = BGM_RSE_BATTLE_REGI,
	[SPECIES_REGISTEEL] = BGM_RSE_BATTLE_REGI,

	[SPECIES_DARKRAI] = BGM_RSE_BATTLE_LEGEND,
	[SPECIES_CRESSELIA] = BGM_RSE_BATTLE_LEGEND,
};
