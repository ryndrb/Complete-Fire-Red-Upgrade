...
const struct BattleMove gBattleMoves[] =
{
	...
	[MOVE_RAPIDSPIN] =
	{
		.effect = EFFECT_RAPID_SPIN | EFFECT_SPEED_UP_1_HIT,
		.power = 50,
		.type = TYPE_NORMAL,
		.accuracy = 100,
		.pp = 40,
	...
	[MOVE_KINGSSHIELD] =
	{
		.effect = EFFECT_PROTECT | EFFECT_ATTACK_DOWN_HIT,
		.power = 0,
		.type = TYPE_STEEL,
		.accuracy = 0,
		.pp = 10,
	...
	[MOVE_TOXICTHREAD] =
	{
		.effect = EFFECT_POISON | EFFECT_SPEED_DOWN | EFFECT_DEFENSE_DOWN | EFFECT_SPECIAL_DEFENSE_DOWN,
		.power = 0,
		.type = TYPE_POISON,
		.accuracy = 100,
		.pp = 20,
	...
	[MOVE_RAGINGFURY] =
	{
		...
		.z_move_power = 175,
		#else
		.power = 90, //Other rampage moves also had power reduced to 90 in PLA
		.z_move_power = 190,
		#endif
		.type = TYPE_FIRE,
		.accuracy = 100,
	...
	[MOVE_WAVECRASH] =
	{
		...
		.secondaryEffectChance = 0,
		.target = MOVE_TARGET_SELECTED,
		.priority = 0, //"Raises user's action speed" is said about PLA's equivalent to Priority moves
		.flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED,
		.z_move_power = 140,
		.split = SPLIT_PHYSICAL,
		.z_move_effect = 0
