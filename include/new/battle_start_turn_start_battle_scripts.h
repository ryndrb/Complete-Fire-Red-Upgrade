...
extern const u8 BattleScript_TotemMultiBoost[];
extern const u8 BattleScript_TotemMultiBoostRet[];
...
extern const u8 BattleScript_PixieBoost[];
extern const u8 BattleScript_PixieBoostRet[];
