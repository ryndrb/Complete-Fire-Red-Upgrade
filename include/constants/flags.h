...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
// New Flags
#define FLAG_CHOOSE_REGION_KANTO 0x208
#define FLAG_CHOOSE_REGION_JOHTO 0x209
#define FLAG_CHOOSE_REGION_HOENN 0x20A
#define FLAG_CHOOSE_REGION_SINNOH 0x20B
#define FLAG_CHOOSE_REGION_UNOVA 0x20C
#define FLAG_CHOOSE_REGION_KALOS 0x20D
#define FLAG_CHOOSE_REGION_ALOLA 0x20E
#define FLAG_CHOOSE_REGION_GALAR 0x20F

#define FLAG_BRENDAN_PEWTER_SPRITE1 0x300
#define FLAG_BRENDAN_PEWTER_ENCOUNTER 0x301
#define FLAG_LAVENDER_MECHANT_1 0x302
#define FLAG_LAVENDER_MECHANT_2 0x303
#define FLAG_BRENDAN_PEWTER_SPRITE2 0x304
#define FLAG_TRAYNEE_ROUTE5_GREET 0x305
#define FLAG_TRAYNEE_EXP_TRAINING_NO_EV 0x306
#define FLAG_TRAYNEE_HP_TEAM 0x307
#define FLAG_TRAYNEE_ATT_TEAM 0x308
#define FLAG_TRAYNEE_DEF_TEAM 0x309
#define FLAG_TRAYNEE_SPA_TEAM 0x30A
#define FLAG_TRAYNEE_SPD_TEAM 0x30B
#define FLAG_TRAYNEE_SPE_TEAM 0x30C
#define FLAG_LANCE_SPRITE_PEWTER 0x30D
#define FLAG_IVY_ROUTE5_GREET 0x30E
#define FLAG_IVY_MAX_IVS 0x30F
#define FLAG_NURSE_JOY_POKE_VIAL 0x310
#define FLAG_BRENDAN_CATCH_FIRST_MON 0x311
#define FLAG_BRENDAN_PEWTER_SPRITE3 0x312
...
#define FLAG_OBTAIN_AMULET_COIN 0x0B1
#define FLAG_OBTAIN_SOOTHE_BELL 0x0B2
#define FLAG_OBTAIN_BIG_ROOT 0x0B3
#define FLAG_OBTAIN_BINDING_BAND 0x0B4
#define FLAG_OBTAIN_SHELL_BELL 0x0B5
#define FLAG_OBTAIN_TOXIC_ORB 0x0B6
#define FLAG_OBTAIN_FLAME_ORB 0x0B7
#define FLAG_OBTAIN_ZOOM_LENS 0x0B8
#define FLAG_OBTAIN_PROTECTIVE_PADS 0x0B9
#define FLAG_OBTAIN_LIFE_ORB 0x0BA
#define FLAG_OBTAIN_EVIOLITE 0x0BB
#define FLAG_OBTAIN_WEATHER_ROCKS 0x0BC
#define FLAG_OBTAIN_GIFT_TIMBURR 0x0BD
#define FLAG_OBTAIN_GIFT_SANDILE 0x0BE

#define FLAG_OBTAIN_GIFT_VENOSHOCK 0x0BF
#define FLAG_OBTAIN_GRASS_KNOT 0x0C0
#define FLAG_OBTAIN_SMACK_DOWN 0x0C1
#define FLAG_OBTAIN_SNARL 0x0C2
#define FLAG_OBTAIN_FLAME_CHARGE 0x0C3
#define FLAG_OBTAIN_ROCK_SLIDE 0x0C4
#define FLAG_OBTAIN_DREAM_EATER 0x0C5
#define FLAG_OBTAIN_STRUGGLE_BUG 0x0C6
#define FLAG_OBTAIN_DAZZLING_GLEAM 0x0C7
#define FLAG_OBTAIN_SLUDGE_WAVE 0x0C8
#define FLAG_OBTAIN_PSYSHOCK 0x0C9
#define FLAG_OBTAIN_ACROBATICS 0x0CA
#define FLAG_OBTAIN_DRAGON_PULSE 0x0CB
#define FLAG_OBTAIN_WILL_O_WISP 0x0CC
#define FLAG_OBTAIN_SHADOW_CLAW 0x0CD
#define FLAG_OBTAIN_AVALANCHE 0x0CE
#define FLAG_OBTAIN_AURORA_VEIL 0x0CF
#define FLAG_OBTAIN_DARK_PULSE 0x0D0
#define FLAG_OBTAIN_FLASH_CANNON 0x0D1
#define FLAG_OBTAIN_WILD_CHARGE 0x0D2
#define FLAG_OBTAIN_POISON_JAB 0x0D3
#define FLAG_OBTAIN_ROOST 0x0D4
#define FLAG_OBTAIN_FALSE_SWIPE 0x0D5
#define FLAG_OBTAIN_DRAIN_PUNCH 0x0D6
#define FLAG_OBTAIN_PAYBACK 0x0D7
#define FLAG_OBTAIN_SWORDS_DANCE 0x0D8
#define FLAG_OBTAIN_SUBSTITUTE 0x0D9
#define FLAG_OBTAIN_X_SCISSOR 0x0DA
#define FLAG_OBTAIN_SLEEP_TALK 0x0DB
#define FLAG_OBTAIN_EXPLOSION 0x0DC
#define FLAG_OBTAIN_ROCK_POLISH 0x0DD
#define FLAG_OBTAIN_GYRO_BALL 0x0DE
#define FLAG_OBTAIN_INCINERATE 0x0DF
#define FLAG_OBTAIN_WORK_UP 0x0E0
#define FLAG_OBTAIN_INFESTATION 0x0E1
#define FLAG_OBTAIN_DEFOG 0x0E2
#define FLAG_OBTAIN_TRICK_ROOM 0x0E3
#define FLAG_OBTAIN_STONE_EDGE 0x0E4
#define FLAG_OBTAIN_BRINE 0x0E5

#define FLAG_OBTAIN_ABSOLITE 0x0E6
#define FLAG_OBTAIN_AGGRONITE 0x0E7
#define FLAG_OBTAIN_AMPHAROSITE 0x0E8
#define FLAG_OBTAIN_AUDINITE 0x0E9
#define FLAG_OBTAIN_BANETTITE 0x0EA
#define FLAG_OBTAIN_CAMERUPTITE 0x0EB
#define FLAG_OBTAIN_GLALILITE 0x0EC
#define FLAG_OBTAIN_HERACRONITE 0x0ED
#define FLAG_OBTAIN_KANGASKHANITE 0x0EE
#define FLAG_OBTAIN_LOPUNITE 0x0EF
#define FLAG_OBTAIN_LUCARIONITE 0x0F0
#define FLAG_OBTAIN_MAWILITE 0x0F1
#define FLAG_OBTAIN_MEDICHAMITE 0x0F2
#define FLAG_OBTAIN_PIDGEOTITE 0x0F3
#define FLAG_OBTAIN_PINSIRITE 0x0F4
#define FLAG_OBTAIN_SABLENITE 0x0F5
#define FLAG_OBTAIN_SCIZORITE 0x0F6
#define FLAG_OBTAIN_SHARPEDONITE 0x0F7
#define FLAG_OBTAIN_SLOWBRONITE 0x0F8
#define FLAG_OBTAIN_AERODACTYLITE 0x0F9
#define FLAG_OBTAIN_GYARADOSITE 0x0FA
#define FLAG_OBTAIN_MANECTITE 0x0FB
#define FLAG_OBTAIN_ABOMASITE 0x0FC
#define FLAG_OBTAIN_ALAKAZITE 0x0FD
#define FLAG_OBTAIN_GENGARITE 0x0FE
#define FLAG_OBTAIN_HOUNDOOMINITE 0x0FF
#define FLAG_OBTAIN_STEELIXITE 0x100
...
#define FLAG_BRENDAN_VICTORYROAD_ENCOUTER 0x939
