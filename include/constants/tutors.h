...
enum MoveTutors
{
	...
	// Legens Arcues
	TUTOR146_DIRE_CLAW,
	TUTOR147_PSYSHIELD_BASH,
	TUTOR148_POWER_SHIFT,// wont use
	TUTOR149_STONE_AXE,
	TUTOR150_MYSTICAL_POWER,
	TUTOR151_RAGING_FURY,
	TUTOR152_WAVE_CRASH,
	TUTOR153_CHLOROBLAST,
	TUTOR154_MOUNTAIN_GALE,
	TUTOR155_VICTORY_DANCE,
	TUTOR156_HEADLONG_RUSH,
	TUTOR157_BARB_BARRAGE,
	TUTOR158_ESPER_WING,
	TUTOR159_BITTER_MALICE,
	TUTOR160_SHELTER,// wont use
	TUTOR161_TRIPLE_ARROWS,
	TUTOR162_INFERNAL_PARADE,
	TUTOR163_CEASELESS_EDGE,
	TUTOR164_BLEAKWIND_STORM,
	TUTOR165_WILDBOLT_STORM,
	TUTOR166_SANDSEAR_STORM,
	TUTOR167_SPRINGTIDE_STORM,
	TUTOR168_LUNAR_BLESSING,
	TUTOR169_TAKE_HEART,
};
...
{
	TUTOR_SPECIAL_DRACO_METEOR,			//170 - Dragon Pokemon
	TUTOR_SPECIAL_SECRET_SWORD,			//171 - Keldeo only
	TUTOR_SPECIAL_RELIC_SONG,			//172 - Meloetta only
	TUTOR_SPECIAL_VOLT_TACKLE,			//173 - Pikachu only
	TUTOR_SPECIAL_DRAGON_ASCENT,		//174 - Rayquaza only
	TUTOR_SPECIAL_THOUSAND_ARROWS,		//175 - Zygarde only
	TUTOR_SPECIAL_THOUSAND_WAVES,		//176 - Zygarde only
	TUTOR_SPECIAL_CORE_ENFORCER,		//177 - Zygarde only
	TUTOR_SPECIAL_STEEL_BEAM,			//178 - Steel Pokemon
};
